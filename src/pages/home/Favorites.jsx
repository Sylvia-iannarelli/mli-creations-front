  ...
  return (
    <div className='max-w-screen-2xl mx-auto container xl:px-28 px-4'>
        ...
        <div className='my-4 flex flex-col md:flex-row items-center gap-4'>
            <p className='uppercase md:-rotate-90 text-center bg-Black text-white md:p-1.5 p-2 rounded-lg inline-flex items-center'>Les coups de cœur <PiHeartStraightThin /> <PiHeartStraightThin /> <PiHeartStraightThin /></p>
